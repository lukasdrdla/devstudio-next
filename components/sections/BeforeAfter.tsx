      ...
      <section className="py-16 sm:py-24 lg:py-32 px-4 sm:px-6 lg:px-12">
        <div className="max-w-[1100px] mx-auto">
          ...
          >
            ...
            <p className="text-base sm:text-lg text-muted-foreground max-w-[500px] mb-10 sm:mb-16">
          ...
          >
            ...
            <div className="hidden sm:flex bg-surface-secondary px-4 py-3 items-center gap-3 border-b border-border">
              ...
              <div className="flex-1 flex justify-center">
                <div className="bg-surface rounded-lg px-4 py-1.5 text-xs text-muted-foreground border border-border w-64 text-center">
            ...
            <div className="sm:hidden bg-surface-secondary px-3 py-2 flex items-center justify-center gap-2 border-b border-border">
              ...
              <span className="text-xs text-muted-foreground">Přejeďte prstem pro porovnání</span>
            </div>
