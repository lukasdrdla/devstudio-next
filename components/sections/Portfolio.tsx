...
const projects = [
  {
    id: 1,
    title: 'E-shop FLAVEX',
    subtitle: 'Prémiový e-commerce pro značku doplňků stravy',
    type: 'E-commerce',
  ...
  },
  {
    ...
    subtitle: 'Komplexní řešení pro správu rezervací',
  ...
  {
    id: 3,
    title: 'Landing DEVELOPER',
    subtitle: 'Konverzní landing page pro SaaS produkt',
    type: 'Landing page',
    image: '/projects/259shots_so.webp',
    stat: '+320%',
    statLabel: 'návštěvnosti',
  ...
  },
  {
    ...
    subtitle: 'Profesionální web s důrazem na SEO',
    type: 'Webové stránky',
