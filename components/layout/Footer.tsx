...
export function Footer() {
  return (
    <footer className="bg-gray-950 dark:bg-black text-white">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 sm:gap-8 lg:gap-12">
            ...
            <div className="sm:col-span-2 lg:col-span-1">
              <Link href="/" className="inline-flex items-center gap-3 mb-4 sm:mb-6">
                <div className="w-10 h-10 bg-white rounded-xl flex items-center justify-center text-gray-900 font-bold text-base">
                  W
                </div>
              ...
              <ul className="space-y-3">
                {services.map((item) => (
                  <li key={item.label}>
                    <Link
                      href={item.href}
                      className="text-sm sm:text-[15px] text-gray-400 hover:text-white transition-colors inline-block py-0.5"
                    >
                      {item.label}
                    </Link>
                  </li>
              ...
              <ul className="space-y-4">
                <li>
                  <a
                    ...
                    className="flex items-center gap-3 text-sm sm:text-[15px] text-gray-400 hover:text-white transition-colors group"
                  >
